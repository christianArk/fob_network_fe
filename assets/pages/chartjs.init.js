    ...
    (ChartJs.prototype.init = function () {
      ...
      var donutChart = {
        ...
        datasets: [
          {
            data: [250, 60],
            backgroundColor: ["#23cbe0", "#f0f4f7"],
            hoverBackgroundColor: ["#23cbe0", "#f0f4f7"],
      ...
      var pieChart = {
        ...
        datasets: [
          {
            data: [350, 200],
            backgroundColor: ["#0e86e7", "#f0f4f7"],
            hoverBackgroundColor: ["#0e86e7", "#f0f4f7"],
            hoverBorderColor: "#fff",
          },
        ],
      };
      ...
      var polarChart = {
        datasets: [
          {
            data: [8, 3, 5, 6],
            backgroundColor: ["#23cbe0", "#20d4b6", "#0e86e7", "#745af1"],
