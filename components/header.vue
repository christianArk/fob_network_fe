  ...
  <div class="topbar">
    ...
    <div class="topbar-left">
      <a href="index.html" class="logo">
        <img
          src="~/~/assets/images/mevron_logo.png"
          class="logo-lg"
          alt=""
          height="22"
        />
        <img
          src="~/~/assets/images/mevron_logo_sm.png"
          class="logo-sm"
          alt=""
          height="24"
        />
    ...
    <nav class="navbar-custom">
      <ul class="navbar-right list-inline float-right mb-0">
        <li
          class="list-inline-item dropdown notification-list d-none d-md-inline-block"
        >
          <a
        ...
        <li
          class="dropdown notification-list list-inline-item d-none d-md-inline-block"
        >
          <a id="btn-fullscreen" class="nav-link waves-effect" href="#">
