          ...
          <div class="card-body">
              ...
              <form class="form-horizontal mt-4" autocomplete="off">
                  ...
                  <div class="form-group text-center mt-3">
                      <div class="col-12">
                          <button class="btn btn-black btn-block waves-effect waves-light"
                          type="submit" :disabled="false">Log In</button>
                      </div>
                  </div>
                  ...
                  <div class="form-group text-center mt-4">
                      <div class="col-12">
                          <div class="float-left">
                            ...
                            <i class="fa fa-lock mr-1"></i> Forgot your password?</nuxt-link>
                          </div>
